...
public class RegularBullet : Bullet
{
    ...
    { 
        ...
        set
        {
            ...
            rigidBody2d.linearDamping = BulletData.Friction;
        }
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            if (ScoreManager.Instance != null) ScoreManager.Instance.RegisterShot(false);
            HitObstacle(collision);
        }else if (collision.gameObject.layer == LayerMask.NameToLayer("Enemy"))
        {
            if (ScoreManager.Instance != null) ScoreManager.Instance.RegisterShot(true);
            HitEnemy(collision);
        }
        Destroy(gameObject);
    }
